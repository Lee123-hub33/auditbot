...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "role",
            sa.Enum("VIEWER", "UPLOADER", "REVIEWER", "ADMIN", name="userrole"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum(
                "PENDING", "PROCESSING", "COMPLETED", "FAILED", name="processstatus"
            ),
            nullable=False,
        ),
    ...
    op.create_index(
        "idx_documents_deleted_at", "documents", ["deleted_at"], unique=False
    )
    ...
    op.create_index(
        "idx_documents_uploaded_by", "documents", ["uploaded_by"], unique=False
    )
    op.create_table(
        "refresh_tokens",
        sa.Column("id", sa.UUID(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column(
            "result",
            sa.Enum("PASSED", "VIOLATION", "WARNING", name="auditresult"),
            nullable=False,
        ),
    ...
    op.create_index(
        "idx_audit_logs_document_id", "audit_logs", ["document_id"], unique=False
    )
