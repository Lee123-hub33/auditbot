...
from sqlalchemy import (
    ...
    Integer, Enum as SQLEnum, Index, Boolean
)
...
class RefreshToken(Base):
    ...
    token_hash = Column(String(128), nullable=False, unique=True)  # store hash, not raw token
...
class Document(Base):
    ...
    secure_filename  = Column(String(255), nullable=False, unique=True)  # random token name on disk
    ...
    logs     = relationship("AuditLog", back_populates="document", cascade="all, delete-orphan")
